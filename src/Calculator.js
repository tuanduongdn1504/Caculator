...
import KeyboardInput from "./component/KeyboardInput";
import CalculatorDisplay from "./component/CalculatorDisplay";
import CalculatorKey from "./component/CalculatorKey";
...
export default class Calculator extends React.Component {
  ...
  inputDigit(digit) {
    ...
    if (waitingForOperand) {
      ...
      this.setState({
        displayValue: displayValue === '0' ? String(digit) : displayValue + digit // String + String
      })
    }
  }
